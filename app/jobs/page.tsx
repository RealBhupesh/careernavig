...
import { Briefcase, Search, MapPin, DollarSign, Clock, ExternalLink } from "lucide-react"
...
export default function JobsPage() {
  ...
  const getMatchColor = (match: number) => {
    ...
    if (match >= 70) return "text-orange-600 dark:text-orange-400"
    return "text-gray-600 dark:text-gray-400"
  }

  const getMatchBgColor = (match: number) => {
    if (match >= 90) return "bg-green-100 dark:bg-green-900"
    if (match >= 80) return "bg-blue-100 dark:bg-blue-900"
    if (match >= 70) return "bg-orange-100 dark:bg-orange-900"
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">AI-Matched Job Listings</h1>
          <p className="text-gray-600 dark:text-gray-400">Jobs ranked by compatibility with your skills and career goals</p>
        </div>
            ...
            <div className="grid md:grid-cols-4 gap-4">
              ...
              <Select value={locationFilter} onValueChange={setLocationFilter}>
                ...
                <SelectContent className="dark:bg-gray-700 dark:border-gray-600">
                  <SelectItem value="all" className="dark:text-white dark:focus:bg-gray-600">All Locations</SelectItem>
                  <SelectItem value="remote" className="dark:text-white dark:focus:bg-gray-600">Remote</SelectItem>
                  <SelectItem value="san francisco" className="dark:text-white dark:focus:bg-gray-600">San Francisco</SelectItem>
                  <SelectItem value="new york" className="dark:text-white dark:focus:bg-gray-600">New York</SelectItem>
                  <SelectItem value="austin" className="dark:text-white dark:focus:bg-gray-600">Austin</SelectItem>
                  <SelectItem value="seattle" className="dark:text-white dark:focus:bg-gray-600">Seattle</SelectItem>
                  <SelectItem value="chicago" className="dark:text-white dark:focus:bg-gray-600">Chicago</SelectItem>
                </SelectContent>
              </Select>
              <Select value={matchFilter} onValueChange={setMatchFilter}>
                ...
                <SelectContent className="dark:bg-gray-700 dark:border-gray-600">
                  <SelectItem value="all" className="dark:text-white dark:focus:bg-gray-600">All Matches</SelectItem>
                  <SelectItem value="90" className="dark:text-white dark:focus:bg-gray-600">90%+ Match</SelectItem>
                  <SelectItem value="80" className="dark:text-white dark:focus:bg-gray-600">80%+ Match</SelectItem>
                  <SelectItem value="70" className="dark:text-white dark:focus:bg-gray-600">70%+ Match</SelectItem>
                </SelectContent>
              </Select>
        ...
        <div className="space-y-6">
          {filteredJobs.map((job) => (
            <Card key={job.id} className="hover:shadow-lg transition-shadow dark:bg-gray-800 dark:border-gray-700">
              <CardContent className="p-6">
